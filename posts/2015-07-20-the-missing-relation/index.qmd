...
*Note: In January 2022, I transferred this post from a previous blog host,  edited it slightly, and added the R code chunks for reproducibility.*
...
[ggplot2](https://CRAN.R-project.org/package=ggplot2) for creating the charts    
[distill](https://CRAN.R-project.org/package=distill) for creating the post    
