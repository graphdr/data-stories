...
draft: false
categories: [R, Data storytelling, Visual lies]
image: "thumbnail.png"
cap-location: margin
---
...
:::{.callout-note}
## Summary 
<small><em>I critique and correct a well-known visual lie from a 2015 Congressional hearing in which the authors abuse chart-making conventions to serve their rhetorical goals. I explore what authentic stories these data tell and what authentic questions the data raise. Originally posted in 2017, here I update the data set through 2020, comment on the emerging trends, and 
add R code and provide data sets for reproducibility. </em></small>
:::
