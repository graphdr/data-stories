...
categories: [R, ggplot2, data storytelling, magick]
image: "thumbnail.png"
cap-location: margin
draft: false
---
...
The data with current taxonomy are saved in the blog data directory as a [CSV file](https://raw.githubusercontent.com/graphdr/data-stories/main/data/data/antibiotic-bacteria-log10-mic.csvv).
...
ggplot(DT_facet, aes(x = Concentration, y = Bacteria, color = efficacy)) +
  ...
  # annotations
  geom_vline(xintercept = -1, linetype = 2, size = 0.5, color = "gray40") +
  ...
  theme(
    ...
    # panels
    panel.border  = element_rect(fill = NA, color = "gray90", size = 0.7),
