...
![(Original Table 3) Percentage student responses for each question in the feedback form.](images/survey-data.png)
...
```{r fig.asp=0.35, code_folding="R Code"}
