...
```{r chart-assignment-1, fig.asp=1.6/1}
...
```{r label: chart-assignment-2, fig.asp=1.5/1}
...
```{r chart-assignment-3, fig.asp=1/1}
# edit the previous chart 
p <- p  +
...
```{r label: chart-assignment-4, fig.asp=1/1}
